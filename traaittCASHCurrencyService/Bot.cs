...
namespace TrtlBotSharp
{
    partial class TrtlBotSharp
    {
        ...
        public static async void RunBotAsync()
        {
            ...
            // Load local files
            Log(0, "traaittCASH Currency Service", "Loading config");
            await LoadConfig();
            Log(0, "traaittCASH Currency Service", "Loading database");
            await LoadDatabase();
            ...
            Log(0, "traaittCASH Currency Service", "Starting discord client");
            await RegisterCommandsAsync();
            await _client.LoginAsync(TokenType.Bot, botToken);
            await _client.StartAsync();

            // Set tip bot address
            Log(0, "traaittCASH Currency Service", "Setting default address");
            await SetAddress();
        ...
        private static Task Ready()
        {
            ...
            if (!Monitoring)
            {
                Log(0, "traaittCASH Currency Service", "Starting wallet monitor");
                BeginMonitoring();
                Monitoring = true;
            }
        ...
        private static Task Log(LogMessage arg)
        {
            ...
            if (arg.Message.Contains("Disconnected"))
                Log(0, "traaittCASH Currency Service", "Restarting bot...");
